...
from nivel_4_advanced.code.book_repository import BookRepository


# Se observa ca functiile de test nu se modifica

# Asta inseamna ca refactorizarea codului nu a modificat comportamentul acestuia
